...
export function ProductCard({
  ...
  // Display price: addons are ₹19, books show their actual price
  const displayPrice = productType === 'addon' ? 19 : price;
  ...
  return (
    <div className={cn(
      ...
      <div className="relative h-48 bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center overflow-hidden">
        ...
        {/* Class level badge */}
        <div className="absolute top-3 right-3 px-3 py-1 rounded-full bg-background/90 text-xs font-medium text-foreground">
